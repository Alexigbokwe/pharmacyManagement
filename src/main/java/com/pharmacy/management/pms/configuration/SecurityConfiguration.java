        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http.cors(Customizer.withDefaults())
                                .csrf(csrf -> csrf.disable()).authorizeHttpRequests(request -> request
                                                ...
                                                .requestMatchers("/api/v1/pharmacist/**", "/api/v1/brands/**",
                                                                "/api/v1/groups/**",
                                                                "/api/v1/medicines/**")
                                                .hasAnyRole(ADMIN.name(), PHARMACIST.name())

                                                .requestMatchers(GET, "/api/v1/pharmacist/**", "/api/v1/brands/**",
                                                                "/api/v1/groups/**",
                                                                "/api/v1/medicines/**")
                                                .hasAnyAuthority(ADMIN_READ.name(), PHARMACIST_READ.name())

                                                .requestMatchers(POST, "/api/v1/pharmacist/**", "/api/v1/brands/**",
                                                                "/api/v1/groups/**",
                                                                "/api/v1/medicines/**")
                                                .hasAnyAuthority(ADMIN_CREATE.name(), PHARMACIST_CREATE.name())

                                                .requestMatchers(PUT, "/api/v1/pharmacist/**", "/api/v1/brands/**",
                                                                "/api/v1/groups/**",
                                                                "/api/v1/medicines/**")
                                                .hasAnyAuthority(ADMIN_UPDATE.name(), PHARMACIST_UPDATE.name())

                                                .requestMatchers(DELETE, "/api/v1/pharmacist/**", "/api/v1/brands/**",
                                                                "/api/v1/groups/**",
                                                                "/api/v1/medicines/**")
